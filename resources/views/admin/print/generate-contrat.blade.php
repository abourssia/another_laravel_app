...
<table>
  <tr>
    <th class="timg">   
          <img src="{{ public_path('images/logoatrst.jpg') }}" width="500" height="500">
 </th>
...
<br> &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; nommé(e) à l’article 1, ayant participé à l’évaluation et l’expertise des projets <b> {{$projet}}</b> 
