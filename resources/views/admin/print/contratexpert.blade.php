  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Contrat Expert</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Contrat Expert</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="container-fluid">
          ...
          <form action="{{url('admin/print/Contratexpert/generate-pdf')}}" method="GET">
          @csrf
...
<label for="Projets"> Projets </label>
        <select multiple name="projets[]" id="projets" class="form-control"> 
        <option value="evalLabo">Eval Labo</option>
        <option value="creaLabo">creaLabo </option>
